...
impl ScheduledTransactionDetail {
    pub fn new(id: uuid::Uuid, date_first: String, date_next: String, frequency: Frequency, amount: i64, account_id: uuid::Uuid, deleted: bool, account_name: String, subtransactions: Vec<models::ScheduledSubTransaction>) -> ScheduledTransactionDetail {
