...
impl TransactionDetail {
    pub fn new(id: String, date: String, amount: i64, cleared: models::TransactionClearedStatus, approved: bool, account_id: uuid::Uuid, deleted: bool, account_name: String, subtransactions: Vec<models::SubTransaction>) -> TransactionDetail {
        TransactionDetail {
            id,
            date,
            amount,
